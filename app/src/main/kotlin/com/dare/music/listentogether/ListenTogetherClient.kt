...
import com.dare.music.constants.ListenTogetherAutoApprovalKey
import com.dare.music.constants.ListenTogetherAutoApproveSuggestionsKey
import com.dare.music.constants.ListenTogetherIsHostKey
import com.dare.music.constants.ListenTogetherRoomCodeKey
import com.dare.music.constants.ListenTogetherServerUrlKey
import com.dare.music.constants.ListenTogetherSessionTimestampKey
import com.dare.music.constants.ListenTogetherSessionTokenKey
import com.dare.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.dare.music.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.dare.music.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.dare.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.dare.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.dare.music.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[com.dare.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
