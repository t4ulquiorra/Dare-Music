...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.dare.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.dare.music.widget.LIKE"
        const val ACTION_NEXT = "com.dare.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.dare.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.dare.music.widget.UPDATE_WIDGET"
    }
}
